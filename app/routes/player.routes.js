module.exports = app => {
    ...
    // Login
    router.post("/login", player.playerLogin);

    // Retrieve Player (self)
    router.get("/get", authPlayer.verifyToken, player.playerGet);

    // Update Player's Username
    router.post("/update", authPlayer.verifyToken, player.playerUpdate);
